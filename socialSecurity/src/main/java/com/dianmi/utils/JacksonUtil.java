...
/**
 * created by www 2017/9/28 17:52
 */
public class JacksonUtil {
	 ...
	 */
	/*
	 * public static List<Map<String, Object>> jsonArray2ListMap(String
	 * jsonArray) { List<Map<String, Object>> convertedListMap = null; try {
	 * convertedListMap = objectMapper.readValue(jsonArray, new
	 * TypeReference<List<Map<String, Object>>>() { }); } catch (IOException e)
	 * { e.printStackTrace(); } return convertedListMap; }
	 * 
	 *//**
		 * json转map
		 *
		 ...
		 * @return map对象
		 *//*
		 * public static Map<String, Object> json2Map(String json) { Map<String,
		 * Object> convertedMap = null; try { convertedMap =
	...
	// try {
	// map = xmlMapper.readValue(xmlStr, new TypeReference<Map<String,
	// Object>>() {
	// });
	// } catch (IOException e) {
	// e.printStackTrace();
	...
	// try {
	// listMap = xmlMapper.readValue(xmlStr, new TypeReference<List<Map<String,
	// Object>>>() {
	// });
	// } catch (IOException e) {
	// e.printStackTrace();
